...
public class OrderDetailsServlet extends HttpServlet {
    ...
    private void orderDetails(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException {
        String id = request.getParameter("id");
        List<OrderDetails> listOrderDetails = sachDAO.orderDetails(Integer.parseInt(id));
