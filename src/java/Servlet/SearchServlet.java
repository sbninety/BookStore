...
public class SearchServlet extends HttpServlet {
    ...
    private void searchSach(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException {
        String name = request.getParameter("txt");
        List<Sach> listSach = sachDAO.searchSach(name);
