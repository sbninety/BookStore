 ...
 * @author vannh
 */
@WebServlet(name = "TheLoaiServlet", urlPatterns = {"/TheLoai"})
public class TheLoaiServlet extends HttpServlet {
    ...
    private void listTheLoai(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException {
        String id = request.getParameter("MaTheLoai");
        List<Sach> listSach = sachDAO.getSachByTheLoai(id);
