 ...
 * @author vannh
 */
@WebServlet(name = "EDeleteOrderServlet", urlPatterns = {"/EDeleteOrder"})
public class EDeleteOrderServlet extends HttpServlet {
    SachDAO sachDAO;
    ...
    private void deleteOrder(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
        ...
        sachDAO.deleteOrderDetails(Integer.parseInt(id));
        sachDAO.deleteOrder(Integer.parseInt(id));
        response.sendRedirect("EOrder");
    }
}
